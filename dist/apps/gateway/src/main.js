...
let AuthController = AuthController_1 = class AuthController {
    ...
    async signupLocal(dto, res, req) {
        try {
            console.log(dto);
            const { email, userId } = await this.authService.signup({ email: dto.email, username: dto.username, password: dto.password });
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], PredictController.prototype, "test", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
